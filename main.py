...
def map_init():
     global map_home_index
     global map_array
     map_home_index = [23,15]
     map_array = ([" "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," ","u'\u2588'","u'\u2588'","u'\u2588'","u'\u2588'","u'\u2588'","u'\u2588'","u'\u2588'","u'\u2588'","u'\u2588'","u'\u2588'","u'\u2592'","u'\u2592'","u'\u2592'","u'\u2592'","u'\u2592'","u'\u2592'","u'\u2588'","u'\u2588'","u'\u2588'","u'\u2588'","u'\u2588'","u'\u2588'","u'\u2588'"," "," "," "," "," "," "," "," "," "," ","u'\u2588'","u'\u2588'","u'\u2588'","u'\u2588'","u'\u2588'","u'\u2588'","u'\u2588'","u'\u2588'","u'\u2588'","u'\u2588'","u'\u2588'","u'\u2588'","u'\u2588'"],
     ...
     for row in range(0,50):
          for col in range(0,50):
               if map_array[row][col] != " ":
                    buff_cmd = "box_feature.addstr(2+row,2+col,"+map_array[row][col]+".encode('utf-8'))"
                    exec buff_cmd
               else:
                    box_feature.addstr(2+row,2+col," ")
     box_feature.refresh()
...
while run == 1:
     ...
     if cmd == curses.KEY_DOWN and current_menu < len(menu_tree[menu_level])-1: current_menu+=1
          ...
          if menu_tree[menu_level][current_menu] == "QUESTS":
               ...
               menu_level = 'top'
               current_menu = 0 
          elif menu_tree[menu_level][current_menu] == "MAP":
               current_feature = 'map'
               menu_level = 'top'
               current_menu = 0 
